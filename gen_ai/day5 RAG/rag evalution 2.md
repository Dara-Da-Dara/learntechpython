# RAG Evaluation Metrics and Code Examples

Evaluation of RAG models is critical to ensure **accuracy, relevance, and utility** of the generated responses. RAG can be evaluated in two main aspects:

1. **Retrieval Quality**
2. **Generation Quality**

Theory: RAG evaluation combines **retrieval metrics**, which measure how well the system fetches relevant documents, and **generation metrics**, which measure the quality of the generated text based on retrieved context. Human evaluation complements automatic metrics to ensure relevance and factual correctness.
...
```python
ranks = [1, 3, 5]  # positions of first relevant doc for each query
...
| ------------------- | ------------------------------- | -------------------------------------------------- |
| Fluency             | 1=Poor, 5=Excellent             | Measures readability and grammatical quality       |
| Relevance           | 1=Irrelevant, 5=Highly Relevant | Measures alignment with query                      |
| Factual Correctness | 1=Incorrect, 5=Accurate         | Measures correctness of information                |
| Completeness        | 1=Incomplete, 5=Complete        | Measures if all aspects of the query are addressed |
...
* RAG evaluation combines **retrieval metrics, generation metrics, and human evaluation**
* RAG-specific metrics like **Context Utilization and Hallucination Rate** are important
