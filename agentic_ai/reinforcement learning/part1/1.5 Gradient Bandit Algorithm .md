...
Each action \(a\) has a **preference score**:

\[
H(a)
\]

**Probability of choosing action \(a\)** uses **Softmax**:
...
**Symbols:**
- \(\alpha\) = learning rate (0.1 typical)
- \(\bar{R}\) = baseline (running avg reward)
